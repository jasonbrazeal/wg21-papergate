...
> The current best C++ answer to that situation is an immediately invoked lambda. Immediately invoked lambdas are decent enough solutions for that problem, but they are not perfect.

## who is affected: not addressed

## prior art and alternatives: supported with specifics
> [P2552R2] Timur Doumler. 2023-05-19. On the ignorability of standard attributes. [P2561R2] Barry Revzin. 2023-05-18. A control flow operator. [P2688R4] Michael Park. 2024-12-17. Pattern Matching: match Expression. [P2806R0] Barry Revzin, Bruno Cardoso Lopez, Zach Laine, Michael Park. 2023-02-14. do expressions.
...
> This problem surfaces especially brightly in the context of [[P2688R4] (Pattern Matching: `match` Expression)](https://wg21.link/P2688R4), where the current design is built upon a sequence of: `pattern => expression;`
