...
Criteria addressed: 7 of 7. Points: 12 of 14. Unsupported quotes rejected: 3. Replies missing: 0.

## motivation - grade 2 (UNSTABLE: votes cross zero)
votes: chunk 1: 2/2/2  chunk 2: 0/0/0  chunk 3: 0/0/1  chunk 4: 0/1/1
...
## audience - grade 1
votes: chunk 1: 1/1/2  chunk 2: 0/0/0  chunk 3: 0/0/0  chunk 4: 0/0/0
quote: Boost has a number of queues, as official library and as example uses of synchronization primitives.

## prior_art - grade 2 (UNSTABLE: votes cross zero)
votes: chunk 1: 2/2/2  chunk 2: 2/2/2  chunk 3: 0/0/2  chunk 4: 2/2/2
quote: [Non-Blocking Support for `std::execution` (P3669)](https://wg21.link/P3668) tries to fix the problem in the scheduler interface.
