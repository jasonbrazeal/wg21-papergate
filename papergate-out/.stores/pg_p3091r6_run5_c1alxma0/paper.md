...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto iter = m.find(k);
T x = iter == m.end() ? T{} : iter-&gt;second;</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>T x = m.lookup(k).value_or(T{});</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto iter = m.find(k);
T x = iter == m.end() ?
    T(a1...aN) : iter-&gt;second;</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>T x = m.lookup(k).value_or(T(a1...aN));</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto iter = m.find(k);
T&amp; x = iter == m.end() ? v : iter-&gt;second;</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>T&amp; x = std::reference_or(m.lookup(k), v);  // assuming P1255</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>map&lt;K, vector&lt;U&gt;&gt; m{ ... };
auto iter = m.find(k);
span&lt;U&gt; x = iter == m.end() ?
    span&lt;U&gt;{} : iter-&gt;second;</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>map&lt;K, vector&lt;U&gt;&gt; m{ ... };
span&lt;U&gt; x = value_or&lt;span&lt;U&gt;&gt;(m.lookup(k)); // assuming P1255</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>map&lt;K, vector&lt;U&gt;&gt; m{ ... };
...
span&lt;const U&gt; x = iter == m.end() ?
    span&lt;const U&gt;(preset) : iter-&gt;second;</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>map&lt;K, vector&lt;U&gt;&gt; m{ ... };
const array&lt;U, N&gt; preset{ ... };
span&lt;const U&gt; x =
  value_or&lt;span&lt;const U&gt;&gt;(m.lookup(k), preset); // assuming P1255</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>unordered_map&lt;K, U*&gt; m{ ... };
...
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>if (auto iter = m.find(k); iter != m.end()) {
  T&amp; r = iter-&gt;second;
  // use r ...
}</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>if (auto q = m.lookup(k); q) {
  T&amp; r = *q;
  // use r ...
}
&#10;
...
<table border="1" rules="all" cellpadding="6" cellspacing="0" style="border-collapse: collapse; width: 100%;">
<tr>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">R0 Design ( get Returns T )</th>
<th style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;">Current Design ( lookup Returns optional&lt;T&amp;&gt; )</th>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto tval = theMap.get(k);</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto tval = theMap.get(k).value_or(T{});</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto tval = theMap.get(k, cT1, cT2);</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto tval = theMap.lookup(k).value_or(T(cT1, cT2));</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto&amp; tref = theMap.get_ref(k, lvalue);</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>// per P1255
auto&amp; tref = reference_or(theMap.lookup(k), lvalue);</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>auto uval = theMap.get&lt;U&gt;(k, cU1, cU2);</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>// per P1255
auto uval = value_or&lt;U&gt;(theMap.lookup(k), cU1, cU2);</code></pre></td>
</tr>
<tr>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>if (auto opt = theMap.get&lt;std::optional&lt;T&amp;&gt;&gt;(k);
    opt) {
  auto&amp; ref = *opt;
  // ...
}</code></pre></td>
<td style="border: 1px solid #999; padding: 6px 10px; vertical-align: top; width: 50%;"><pre style="margin: 0;"><code>if (auto opt = theMap.lookup(k); opt) {
  auto&amp; ref = *opt;
  // ...
}</code></pre></td>
</tr>
