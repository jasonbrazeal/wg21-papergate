...
Criteria addressed: 5 of 7. Points: 10 of 14. Unsupported quotes rejected: 3. Replies missing: 0.
...
quote: Providing the functionality described in this paper is possible using namespace-scope functions, without modifying `std::map` and `std::unordered_map`
